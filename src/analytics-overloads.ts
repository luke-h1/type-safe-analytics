...
export function trackEvent(eventName: "checkout", props: CheckoutEventProps):void

export function trackEvent(eventName: "addToCart", props: AddToCartEventProps):void
